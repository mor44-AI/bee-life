...
export default {
  pt: {
    ...
    'feedQueen.dialLabel': 'FOME',
    'feedQueen.state.calm': 'calma',
    'feedQueen.state.restless': 'inquieta',
    'feedQueen.state.critical': 'crítica!',
    'feedQueen.spare': '1 chance extra',
    'feedQueen.lastTry': 'última chance',
    'feedQueen.keysHint': 'setas ou WASD',
    'feedQueen.free': 'Turno livre',
  ...
  en: {
    ...
    'feedQueen.dialLabel': 'HUNGER',
    'feedQueen.state.calm': 'calm',
    'feedQueen.state.restless': 'restless',
    'feedQueen.state.critical': 'critical!',
    'feedQueen.spare': '1 extra try',
    'feedQueen.lastTry': 'last try',
    'feedQueen.keysHint': 'arrows or WASD',
    'feedQueen.free': 'Free shift',
